...
class LzSeasonsResponses() {
    ...
    var mediumFoodPrices: MutableList<MonthsModel> = ArrayList()
    var lowFoodPrices: MutableList<MonthsModel> = ArrayList()
    var highLivestockPrices: MutableList<MonthsModel> = ArrayList()
    var mediumLivestockPrices: MutableList<MonthsModel> = ArrayList()
    ...
    var nonAgricHighCasualLabourAvailability: MutableList<MonthsModel> = ArrayList()
    var nonAgricLowCasualLabourAvailability: MutableList<MonthsModel> = ArrayList()
