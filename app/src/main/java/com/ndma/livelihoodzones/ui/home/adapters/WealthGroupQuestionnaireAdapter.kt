...
class WealthGroupQuestionnaireAdapter(
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.tvQuestionnaireName.text =
            wealthGroupQuestionnairesList.get(position).questionnaireName
        viewHolder.collectionDate.text =
            wealthGroupQuestionnairesList.get(position).questionnaireStartDate
        viewHolder.icSend.setOnClickListener {
            ...
            wealthGroupQuestionnaireAdapterCallBack.onQuestionnaireItemClicked(
                wealthGroupQuestionnairesList.get(position)
            )
        }
